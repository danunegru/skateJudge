      ...
      try {
        ...
        if (this.event) {
          ...
          if (this.exam) {
            ...
            console.log('📋 A1 Event loaded from IndexedDB:', this.event);
          }
        } else {
          console.warn('⚠️ A1 Event not found in IndexedDB');
        }
      } catch (error) {
        console.error('❌ Error loading A1 events from IndexedDB:', error);
      }
    }
  }
